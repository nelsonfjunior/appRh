...
public class VagaController {
	...
	@Autowired // cria instancia automaticamente
	...
	@SuppressWarnings("null") //implementado pelo vscode
    @RequestMapping(value = "/cadastrarVaga", method = RequestMethod.POST)
	public String form(@Valid Vaga vaga, BindingResult result, RedirectAttributes attributes) {

		if (result.hasErrors()) { // caso deixe o campo vazio
	...
	public ModelAndView listaVagas() { // chamar a view de  lista de vagas
	...
	// chama a view do formulário edição de vaga
